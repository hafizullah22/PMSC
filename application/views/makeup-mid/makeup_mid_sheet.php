...
<head>
    <meta charset="UTF-8">
    <title>MakeUp Mid Top Sheet</title>
    <style>
        body {
...
<?php foreach ($filtered_courses as $course): ?>
    <div class="container">
        <div class="header">
            ...
            <p><strong>Make Up Mid-Term Report</strong></p>
            ...
            <table class="attendance-table" style="width: 100%; border-collapse: collapse;  font-size: 14px;">
                <tr>
                    ...
                    <td colspan="2">
                        <strong>
                            <?= $semester_id . getOrdinalSuffix($semester_id) ?> Semester Make Up Mid Examination - <?= $exam_year ?>
                        </strong>
                    </td>
                </tr>
                <tr>
       ...
       <table class="attendance-table">
                ...
                <tr>
                    <td colspan="2">
                        <?= htmlspecialchars($course->mid_student_list) ?>
                    </td>
                </tr>
            </table>

        <div class="exam_info">
        <p>Total number of students: <?= count(array_filter(explode(',', $course->mid_student_list))) ?></p>
