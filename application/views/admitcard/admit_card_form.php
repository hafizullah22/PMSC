<div class="card shadow-sm mb-4">
  <div class="card-body">
    <h4 class="card-title mb-3">🎓 Generate Admit Card</h4>

    <form method="get" action="<?= site_url('admitcard/generate_all') ?>" target="_blank" class="row g-3">
      ...
      <!-- Submit Button -->
      <div class="col-12">
        <button type="submit" class="btn btn-primary w-100">📥 Generate Admit Cards</button>
      </div>
    </form>
  </div>
</div>
