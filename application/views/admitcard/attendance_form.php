<div class="card shadow-sm mb-4">
  <div class="card-body">
    <h4 class="card-title mb-3">📋 Generate Attendance Sheet</h4>

    <form method="get" action="<?= site_url('admitcard/attendance_sheet') ?>" target="_blank" class="row g-3">
      ...
      <!-- Exam Type-->
      <div class="col-md-6">
        <label for="exam_type" class="form-label"><strong>Exam Type</strong></label>
      ...
      <!-- Submit Button -->
      <div class="col-12">
        <button type="submit" class="btn btn-primary w-100">📥 Generate Attendance Sheet</button>
      </div>
    </form>
  </div>
</div>
